#!/usr/bin/env python3
"""
Define human leg muscle with specific parameters

11 leg muscles defined

Author: Guoping Zhao, Lauflabor, gpzhaome@gmail.com
All rights reserved
20180628

v1. checked all dirAng and offsetCorr

"""

import numpy as np
import sys
from thesis_galljamov18.python.muscle_model.mtcmodel import MuscleTendonComplex
...
def HAB(angHipFront):
    ...
    musHAB = MuscleTendonComplex(paraMuscle=paraMuscle, stateMuscle=stateMuscle, paraMusAttach=paraMusAttach,
...
def HAD(angHipFront):
    ...
    stateMuscle = [stim, act, lmtc, lce, vce, frcmtc]
    paraMusAttach = [r, phiref, phimaxref, rho, dirAng, phiScale]
    musHAD = MuscleTendonComplex(paraMuscle=paraMuscle, stateMuscle=stateMuscle, paraMusAttach=paraMusAttach,
...
def VAS(angKne):
    ...
    stateMuscle = [stim, act, lmtc, lce, vce, frcmtc]
    paraMusAttach = [r, phiref, phimaxref, rho, dirAng, phiScale]
    musVAS = MuscleTendonComplex(paraMuscle=paraMuscle, stateMuscle=stateMuscle, paraMusAttach=paraMusAttach,
...
def KneeExtensorMuscle(angKne):
    ...
    stateMuscle = [stim, act, lmtc, lce, vce, frcmtc]
    paraMusAttach = [r, phiref, phimaxref, rho, dirAng, phiScale]
    musKneeExtensor = MuscleTendonComplex(paraMuscle=paraMuscle, stateMuscle=stateMuscle, paraMusAttach=paraMusAttach,
                                 offsetCorr=offsetCorr, timestep=timestep, nameMuscle="KneeExtensor",
                                 angJoi=np.array((angKne,)))
...
def BFSH(angKne):
    ...
    stateMuscle = [stim, act, lmtc, lce, vce, frcmtc]
    paraMusAttach = [r, phiref, phimaxref, rho, dirAng, phiScale]
    musBFSH = MuscleTendonComplex(paraMuscle=paraMuscle, stateMuscle=stateMuscle, paraMusAttach=paraMusAttach,
...
def GAS(angKne, angAnk):
    ...
    stateMuscle = [stim, act, lmtc, lce, vce, frcmtc]
    paraMusAttach = [r, phiref, phimaxref, rho, dirAng, phiScale]
    musGAS = MuscleTendonComplex(paraMuscle=paraMuscle, stateMuscle=stateMuscle, paraMusAttach=paraMusAttach,
...
def SOL(angAnk):
    ...
    stateMuscle = [stim, act, lmtc, lce, vce, frcmtc]
    paraMusAttach = [r, phiref, phimaxref, rho, dirAng, phiScale]
    musSOL = MuscleTendonComplex(paraMuscle=paraMuscle, stateMuscle=stateMuscle, paraMusAttach=paraMusAttach,
...
def TIA(angAnk):
    ...
    stateMuscle = [stim, act, lmtc, lce, vce, frcmtc]
    paraMusAttach = [r, phiref, phimaxref, rho, dirAng, phiScale]
    musTIA = MuscleTendonComplex(paraMuscle=paraMuscle, stateMuscle=stateMuscle, paraMusAttach=paraMusAttach,
